...
abstract class RxBaseRoundProgress : LinearLayout {
    ...
    fun setupStyleable(context: Context, attrs: AttributeSet?) {
        ...
        val colorBackgroundDefault = context.resources.getColor(R.color.round_corner_progress_bar_background_default)
        colorBackground = typedArray.getColor(R.styleable.RxBaseRoundProgress_rcBackgroundColor, colorBackgroundDefault)
        val colorProgressDefault = context.resources.getColor(R.color.round_corner_progress_bar_progress_default)
        colorProgress = typedArray.getColor(R.styleable.RxBaseRoundProgress_rcProgressColor, colorProgressDefault)
        val colorSecondaryProgressDefault = context.resources.getColor(R.color.round_corner_progress_bar_secondary_progress_default)
