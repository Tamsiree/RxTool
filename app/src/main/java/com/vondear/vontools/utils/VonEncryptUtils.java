...
import static com.vondear.vontools.utils.VonDataUtils.bytes2HexString;
import static com.vondear.vontools.utils.VonDataUtils.hexString2Bytes;

/**
 * Created by vondear on 2016/1/24.
 *加密解密相关的工具类
 */
public class VonEncryptUtils {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return VonEncodeUtils.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(VonEncodeUtils.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return VonEncodeUtils.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(VonEncodeUtils.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return VonEncodeUtils.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(VonEncodeUtils.base64Decode(data), key);
    }
