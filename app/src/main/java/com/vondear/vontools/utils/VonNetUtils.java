        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                ...
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    VonUtils.showToast(context, "切换到wifi环境下", false);
                    break;
                case ConnectivityManager.TYPE_MOBILE:
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            VonUtils.showToast(context, "切换到2G环境下", false);
                            break;
                        ...
                        case TelephonyManager.NETWORK_TYPE_HSPAP:
                            VonUtils.showToast(context, "3G", false);
                            break;
                        case TelephonyManager.NETWORK_TYPE_LTE:
                            VonUtils.showToast(context, "4G", false);
                            break;
                        default:
                            VonUtils.showToast(context, "未知网络", false);
                    }
                    break;
                default:
                    VonUtils.showToast(context, "未知网络", false);
