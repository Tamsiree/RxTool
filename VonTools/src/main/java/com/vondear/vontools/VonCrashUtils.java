...
public class VonCrashUtils implements Thread.UncaughtExceptionHandler {

    private volatile static VonCrashUtils mInstance;
    ...
    private VonCrashUtils(Context context) {
     ...
     * @return 单例
     */
    public static VonCrashUtils getInstance(Context context) {
        if (mInstance == null) {
            synchronized (VonCrashUtils.class) {
                if (mInstance == null) {
                    mInstance = new VonCrashUtils(context);
                }
            }
        }
        return mInstance;
    ...
    public void uncaughtException(Thread thread, final Throwable throwable) {
        ...
        if (!VonFileUtils.createOrExistsFile(fullPath)) return;
