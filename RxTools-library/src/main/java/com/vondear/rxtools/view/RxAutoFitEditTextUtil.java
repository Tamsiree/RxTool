 ...
 */
public class RxAutoFitEditTextUtil {


    public static void setNormalization(final Activity a, View rootView, final RxAutoFitEditText aText) {

        // if the view is not instance of AutoFitEditText
        // i.e. if the user taps outside of the box
        if (!(rootView instanceof RxAutoFitEditText)) {
