...
public class VonAppUtils {
    ...
    public static void installApp(Context context, String filePath) {
        installApp(context, VonFileUtils.getFileByPath(filePath));
    }
    ...
    public static void installApp(Context context, File file) {
        if (!VonFileUtils.isFileExists(file)) return;
        context.startActivity(VonIntentUtils.getInstallAppIntent(file));
    }
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        installApp(activity, VonFileUtils.getFileByPath(filePath), requestCode);
    }
    ...
    public static void installApp(Activity activity, File file, int requestCode) {
        if (!VonFileUtils.isFileExists(file)) return;
        activity.startActivityForResult(VonIntentUtils.getInstallAppIntent(file), requestCode);
    }
    ...
    public static boolean installAppSilent(Context context, String filePath) {
        File file = VonFileUtils.getFileByPath(filePath);
        if (!VonFileUtils.isFileExists(file)) return false;
        String command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + filePath;
        VonShellUtils.CommandResult commandResult = VonShellUtils.execCmd(command, !isSystemApp(context), true);
    ...
    public static boolean isSystemApp(Context context, String packageName) {
        if (VonDataUtils.isNullString(packageName)) return false;
        try {
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (VonDataUtils.isNullString(packageName)) return;
        context.startActivity(VonIntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static void uninstallApp(Activity activity, String packageName, int requestCode) {
        if (VonDataUtils.isNullString(packageName)) return;
        activity.startActivityForResult(VonIntentUtils.getUninstallAppIntent(packageName), requestCode);
    }
    ...
    public static boolean isAppRoot() {
        VonShellUtils.CommandResult result = VonShellUtils.execCmd("echo root", true);
        if (result.result == 0) {
            return true;
        }
    ...
    public static void launchApp(Context context, String packageName) {
        if (VonDataUtils.isNullString(packageName)) return;
        context.startActivity(VonIntentUtils.getLaunchAppIntent(context, packageName));
    }
    ...
    public static void launchApp(Activity activity, String packageName, int requestCode) {
        if (VonDataUtils.isNullString(packageName)) return;
        activity.startActivityForResult(VonIntentUtils.getLaunchAppIntent(activity, packageName), requestCode);
    }
    ...
    public static void getAppDetailsSettings(Context context, String packageName) {
        if (VonDataUtils.isNullString(packageName)) return;
        context.startActivity(VonIntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName(Context context, String packageName) {
        if (VonDataUtils.isNullString(packageName)) return null;
        try {
            PackageManager pm = context.getPackageManager();
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (VonDataUtils.isNullString(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppSignatureSHA1(Context context, String packageName) {
        ...
        return VonEncryptUtils.encryptSHA1ToString(signature[0].toByteArray()).
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !VonDataUtils.isNullString(packageName) && packageName.equals(VonProcessUtils.getForegroundProcessName(context));
    }
    //----------------------------------------------------------------------------------------------------------------
    /**
     * 判断App是否安装
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !VonDataUtils.isNullString(packageName) && VonIntentUtils.getLaunchAppIntent(context, packageName) != null;
    }
...
//        }
    ...
    public static boolean cleanAppData(Context context,File... dirs) {
        boolean isSuccess = VonFileUtils.cleanInternalCache(context);
        isSuccess &= VonFileUtils.cleanInternalDbs(context);
        isSuccess &= VonFileUtils.cleanInternalSP(context);
        isSuccess &= VonFileUtils.cleanInternalFiles(context);
        isSuccess &= VonFileUtils.cleanExternalCache(context);
        for (File dir : dirs) {
            isSuccess &= VonFileUtils.cleanCustomCache(dir);
        }
        return isSuccess;
    }
}