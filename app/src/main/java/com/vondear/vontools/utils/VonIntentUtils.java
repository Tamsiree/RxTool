 ...
 */
public class VonIntentUtils {

    private VonIntentUtils() {
    ...
    public static Intent getInstallAppIntent(String filePath) {
        return getInstallAppIntent(VonFileUtils.getFileByPath(filePath));
    }
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            ...
            type = MimeTypeMap.getSingleton().getMimeTypeFromExtension(VonFileUtils.getFileExtension(file));
        }
