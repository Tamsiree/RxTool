...
//		canvas.drawRect(0, 0, getWidth(), getWidth(), paint);// 正方形  
		...
		/*if(progress<50){
			...
			canvas.drawText(VonDataUtils.format2Decimals(getProgress()+""), (centre+90) - moneyPaint.measureText(VonDataUtils.format2Decimals(getProgress()+""))/2-15, centre+105, moneyPaint);//右边最大值
		//}
		canvas.drawText("元", (centre+90) + moneyPaint.measureText(VonDataUtils.format2Decimals(getProgress()+""))/2-10, centre+105, moneyDPaint);//右边最大值
