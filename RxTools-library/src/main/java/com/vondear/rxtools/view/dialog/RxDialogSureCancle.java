...
public class RxDialogSureCancle extends RxDialog {
    ...
    public RxDialogSureCancle(Context context, int themeResId) {
        super(context, themeResId);
        initView();
    }

    public RxDialogSureCancle(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public RxDialogSureCancle(Activity context) {
        super(context);
        initView();
    }

    public RxDialogSureCancle(Context context, float alpha, int gravity) {
        super(context, alpha, gravity);
        initView();
    }

    public RxDialogSureCancle(Context context, float alpha, int gravity, boolean isOnScreen) {
